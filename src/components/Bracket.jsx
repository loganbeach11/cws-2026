  ...
  <Game gameId={10} isAdmin={isAdmin} /><div className="horizontal-line" /></div>
	...
	{/* Column 3 */}
        ...
        {/* Column 4 (If Necessary) */}
	      ...
	      <div className="game-wrapper">
		  <Game gameId={13} isAdmin={isAdmin} /><div className="horizontal-line" />
<div className="bracket-label">Bracket 1 Winner</div>
	      </div>
		  <div style={{ height: "315px" }} />
		  <div className="game-wrapper">
		      <Game gameId={14} isAdmin={isAdmin} /><div className="horizontal-line" />
		      <div className="bracket-label">Bracket 2 Winner</div>
		  </div>
        </div>
