...
function Bracket({ isAdmin }) {
    const { games, updateGame } = useTournament();
  return (
    <div className="bracket-container">
      <div className="bracket-grid">
        ...
        <div className="bracket-column" style={{ marginLeft: "40px" }}>
          ...
          <div className="game-wrapper">
            ...
            <Game gameId={2} isAdmin={isAdmin} />
            <div className="horizontal-line" />
          </div>
	    <div style={{ height: "60px" }} />
          <div className="game-wrapper">
              <div className="game-label">Game 5 - Jun 15 1:00 pm</div>
            <Game gameId={5} isAdmin={isAdmin} />
            <div className="horizontal-line" />
          ...
          <div className="game-wrapper">
            ...
            <Game gameId={4} isAdmin={isAdmin} />
            <div className="horizontal-line" />
          </div>
            <div style={{ height: "60px" }} />
	    <div className="game-wrapper">
		<div className="game-label">Game 7 - Jun 16 - 1:00 pm</div>
            <Game gameId={7} isAdmin={isAdmin} />
            <div className="horizontal-line" />
            <div className="vertical-line line-upward">
              <div className="horizontal-connector bottom" />
            </div>
	    ...
	    <div style={{ height: "60px" }} />
          <div className="game-wrapper">
            ...
            <Game gameId={9} isAdmin={isAdmin} />
            <div className="horizontal-line" />
          </div>
          <div style={{ height: "250px" }} />
          <div className="game-wrapper">
              <div className="game-label">Game 8 - Jun 16 6:00 pm</div>
            <Game gameId={8} isAdmin={isAdmin} />
              <div className="horizontal-line" />
          ...
          <div className="game-wrapper">
            ...
            <Game gameId={10} isAdmin={isAdmin} />
            <div className="horizontal-line" />
          </div>
        </div>
	  {/* Column 3 */}
        <div className="bracket-column">
          ...
          <div className="game-wrapper">
            ...
            <Game gameId={11} isAdmin={isAdmin} />
            <div className="horizontal-line" />
	    ...
	    <div style={{ height: "440px" }} />
          <div className="game-wrapper">
            ...
            <Game gameId={12} isAdmin={isAdmin} />
            <div className="horizontal-line" />
	  ...
	  <div className="bracket-column">
          ...
          <div className="game-wrapper">
            ...
            <Game gameId={13} isAdmin={isAdmin} />
            <div className="horizontal-line" />
          ...
          <div className="game-wrapper">
            <div className="game-label">If necessary - Jun 19 TBD</div>
            <Game gameId={14} isAdmin={isAdmin} />
            <div className="horizontal-line" />
            <div className="bracket-label"></div>
          </div>
          </div>
  ...
  games["15"]?.champion && games["15"].champion !== "TBD" && (
